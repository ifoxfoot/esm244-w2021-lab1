...
### Tidyr::seperate() and unite() funtions
...
### Make some maps of acacia in san fran
...
ggplot(data = blackwood_acacia_sp) + geom_sf(color = "darkgreen")
